...
class Signup(Toplevel):
    ...
    def createWidget(self):
        ...
        tk.Button(self, activebackground='#DD5555', background='#CC5555', width=200, borderwidth=0,font=button_font, text='Create').grid(ipady=5,column=0, sticky=tk.E, row=5, pady=10)
